  ...
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition-all ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-500 data-[state=open]:duration-700",
  {
    variants: {
      side: {
        ...
        bottom:
          "inset-x-0 bottom-0 border-t data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom data-[state=closed]:fade-out-100 data-[state=open]:fade-in-0",
        ...
        right:
          "inset-y-0 right-0 h-full w-3/4 border-l book-open sm:max-w-sm",
      },
    },
    defaultVariants: {
      side: "right",
