<template>
    ...
    >
        ...
        <div class="flex items-center gap-2">
            ...
            <button
                @click="goToFrontend"
                class="rounded-lg p-2 text-gray-700 transition-colors hover:bg-gray-100"
                title="ទៅទំព័រមុខ"
            >
                <Globe class="h-5 w-5" />
            </button>
            ...
            <!-- Settings button -->
            <button class="rounded-lg p-2 text-gray-700 transition-colors hover:bg-gray-100" title="ការកំណត់">
