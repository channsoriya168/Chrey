<template>
    <div class="khmer-text flex min-h-screen items-center justify-center bg-gray-50 px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div class="w-full max-w-md space-y-8">
            <!-- Header -->
            <div>
                <h2 class="khmer-text mt-6 text-center text-3xl font-extrabold text-gray-900">ចូលគណនី</h2>
                <p class="khmer-text mt-2 text-center text-sm text-gray-600">
                    ឬ
                    <Link href="/register" class="font-medium text-blue-600 hover:text-blue-500"> បង្កើតគណនីថ្មី </Link>
                </p>
            </div>
                    ...
                    >
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center">
                                ...
                                />
                                <Label for="remember" class="ml-2 block text-sm text-gray-900"> ចងចាំខ្ញុំ </Label>
                            </div>
