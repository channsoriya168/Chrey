<template>
  <DashboardLayout>
    ...
    <div class="space-y-6 max-w-3xl">
      <!-- Header -->
      <div>
        <h1 class="text-2xl font-bold text-gray-900 khmer-text">កែសម្រួលអ្នកប្រើប្រាស់</h1>
        <p class="text-sm text-gray-600 mt-1 khmer-text">កែប្រែព័ត៌មានអ្នកប្រើប្រាស់</p>
      </div>
      ...
      <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
        <form @submit.prevent="submit" class="space-y-6">
          ...
          <!-- Password Field -->
          <div>
            <Label for="password" class="khmer-text">លេខសម្ងាត់ថ្មី (ទុកឱ្យទទេ ប្រសិនបើមិនចង់ផ្លាស់ប្តូរ)</Label>
            <Input
              id="password"
            ...
            />
            <p class="text-xs text-gray-500 mt-1 khmer-text">ទុកចោល ប្រសិនបើមិនចង់ប្តូរលេខសម្ងាត់</p>
