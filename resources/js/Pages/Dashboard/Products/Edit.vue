    ...
    <div class="space-y-6 pb-32">
        ...
        <div class="flex items-center justify-between">
            ...
            <Button variant="outline" @click="handleCancel"
                class="khmer-text bg-purple-600/80 text-white inline-flex items-center gap-2">
        ...
        <div
            ...
            <div class="mb-6 border-b border-slate-700/50 pb-4">
                <h2 class="khmer-text mb-1 text-2xl font-bold text-white">កែប្រែផលិតផល</h2>
                <p class="text-gray-300">កែប្រែព័ត៍មានខាងក្រោមដើម្បីធ្វើបច្ចុប្បន្នភាពផលិតផល</p>
            </div>
            <vee-form :validation-schema="validationSchema" :initial-values="form" @submit="handleSubmit"
                v-slot="{ errors: veeErrors }">
                <ProductForm v-model:form="form" v-model:image-previews="imagePreviews"
                    v-model:existing-image-urls="existingImageUrls" :vee-errors="veeErrors" submit-text="រក្សាទុក"
                    processing-text="កំពុងរក្សាទុក..." @cancel="handleCancel" />
            </vee-form>
        </div>
    </div>
</template>
