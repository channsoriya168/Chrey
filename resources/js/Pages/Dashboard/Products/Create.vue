    ...
    <div class="space-y-6 pb-32">
        ...
        <div class="flex items-center justify-between">
            ...
            <Button variant="outline" @click="handleCancel"
                class="khmer-text inline-flex items-center gap-2 bg-purple-600/80 text-white">
        ...
        <div
            ...
            <div class="mb-6 border-b border-slate-700/50 pb-4">
                <h2 class="khmer-text mb-1 text-2xl font-bold text-white">បង្កើតផលិតផលថ្មី</h2>
            </div>
            <vee-form :validation-schema="validationSchema" :initial-values="form" @submit="handleSubmit"
                ...
                <ProductForm v-model:form="form" v-model:image-previews="imagePreviews"
                    v-model:existing-image-urls="existingImageUrls" :vee-errors="veeErrors" submit-text="បង្កើត"
                    processing-text="កំពុងបង្កើត..." @cancel="handleCancel" />
            </vee-form>
        </div>
    </div>
</template>
